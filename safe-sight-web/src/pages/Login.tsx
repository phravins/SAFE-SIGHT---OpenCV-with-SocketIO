...
import { ShieldCheck, User as UserIcon, Lock, Mail, Phone, Camera, ArrowRight } from 'lucide-react';
...
const Login: React.FC = () => {
    ...
    const handleUserLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (user.role === 'admin') {
                setError('Admin users must login through Admin tab.');
                setLoading(false);
                return;
            }
            ...
            <div className="w-full max-w-md z-10 relative">
                <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <div className="p-8 pb-0 text-center">
                        ...
                        <p className="text-gray-400 text-sm">Security Monitoring System</p>
                    </div>
                    ...
                    <div className="px-8 pt-6">
                        <div className="flex gap-2 bg-gray-800/50 p-1 rounded-xl">
                            <button
                                ...
                                className={`flex-1 py-2.5 rounded-lg font-medium transition-all ${activeTab === 'user'
                            ...
                            <button
                                ...
                                className={`flex-1 py-2.5 rounded-lg font-medium transition-all ${activeTab === 'admin'
                    ...
                    <div className="p-8">
                            ...
                            <form onSubmit={handleAdminLogin} className="space-y-5">
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-4 py-4 bg-gray-800/50 border border-gray-700 rounded-xl focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 text-white placeholder-gray-500 transition-all outline-none"
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full py-4 bg-purple-600 hover:bg-purple-500 text-white font-semibold rounded-xl shadow-lg shadow-purple-600/20 transition-all transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
                                >
                        ...
                        {activeTab === 'user' && isRegistering && (
                            <form onSubmit={handleRegister} className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <label className="block text-xs text-gray-400 ml-1">Profile Photo (Required)</label>
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full py-4 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl shadow-lg shadow-blue-600/20 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                                >
                        ...
                        {activeTab === 'user' && (
                            <div className="mt-6 pt-6 border-t border-gray-800 text-center">
                                ...
                                >
                                    {isRegistering ? (
                                        <span>Already have an account? <span className="text-blue-400">Sign In</span></span>
                                    ) : (
